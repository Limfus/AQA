...
sorted_people = sorted(people, key=lambda x: (x[1], x[4]))
new_list = sorted_people[2:-2]

female_count = sum(1 for person in new_list if person[4] == 'female')
male_count = sum(1 for person in new_list if person[4] == 'male')
...
print('| sex    | count |')
print('-----------------')
print('| female |  {:<3d}  |'.format(female_count))
print('| male   |  {:<3d}  |'.format(male_count))
print('-----------------')
